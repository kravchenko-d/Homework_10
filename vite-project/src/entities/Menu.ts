...
export default class Menu {
    ...
    mocker(){
        ...
        const lengths = ['25:49', '59:59', '10:41', '3:51', '23:59', '11:50', '8:02', '10:49', '3:47', '8:15', '4:34', '20:04',
        '3:37',
        '3:21',
        '3:11',
        '1:57',
        ...
        const views = [58370, 3915, 644154, 140289, 842973, 103407, 330377, 6963, 4952774, 390641, 918, 553534,
            749754564,
            11921700,
            10461226,
            6440601,
        ...
        const dates = ['2023/08/14', '2023/08/15', '2023/02/20', '2021/04/15', '2023/06/16', '2023/03/08', '2023/05/22', '2023/08/29', '2023/02/26', '2023/09/06', '2023/08/30', '2023/03/03',
        '2023/02/24',
        '2023/02/24',
        '2023/02/24',
        '2023/02/24',
        ...
        const categories = ['Музыка', 'Спорт', 'Блоги', 'Фильмы', 'Новости', 'Музыка', 'Спорт', 'Блоги', 'Фильмы', 'Новости', 'Музыка', 'Спорт']
